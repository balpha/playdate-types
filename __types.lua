...
---@field post (fun(self: pd_http, path: string, headers?: (string|string[]|table)?, data?: string): (boolean,string|nil)) | (fun(self: pd_http, path: string, data: string): (boolean,string|nil))
