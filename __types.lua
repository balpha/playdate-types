...
---@field start fun()
--- Reinitializes the Playdate runtime and restarts the currently running game. The optional string arg passed in is available after restart in playdate.argv as if it had been passed in on the command line when launching the simulator. The argv string will be split on spaces - quote substrings to prevent splitting.
...
---@field recordToSample fun(buffer: pd_sample, completionCallback: fun(pd_sample)): boolean
...
---@field new fun(interval?: number, imageTable?: pd_imagetable|pd_image[], shouldLoop?: boolean): pd_loop
